<nav x-data="{ open: false }" class="bg-indigo-600 border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('produit.index')" :active="request()->routeIs('produit')">
                {{ __('Produit') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('billingData.index')" :active="request()->routeIs('billingData')">
                {{ __('Données de facturation') }}
            </x-responsive-nav-link>
        </div>
